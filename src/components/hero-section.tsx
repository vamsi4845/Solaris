                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Introducing Solaris — Your AI Agent on Solana</span>
                                ...
                                <TextEffect
                                    ...
                                    speedSegment={0.3}
                                    as="h1"
                                    className="mt-8 text-balance text-6xl md:text-7xl max-w-6xl ml-4 lg:mt-16 xl:text-[5.25rem]">
                                    Effortless Interaction with Solana
                                </TextEffect>
                                <TextEffect
                                    per="line"
                                    preset="fade-in-blur"
